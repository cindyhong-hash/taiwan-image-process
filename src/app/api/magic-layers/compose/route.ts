...
import { loadBuffer } from "@/lib/storage";
...
export async function POST(request: Request) {
  try {
    ...
    const body = (await request.json()) as ComposeInput & { backgroundPrompt?: string; ratio?: string };
    ...
    if (bgProvided && !body.canvasWidth && !body.canvasHeight) {
      try {
