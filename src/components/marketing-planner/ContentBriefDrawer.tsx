      ...
      <aside role="dialog" aria-modal="true" aria-labelledby="content-brief-title"
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          ...
          <section className="space-y-4">
            ...
            <div><label className="text-xs font-medium text-gray-600">溝通點</label><textarea value={draft.contentDirection} placeholder="這篇最想讓受眾記住的一件事" onChange={(event) => setDraft((current) => ({ ...current, contentDirection: event.target.value }))} rows={4} className="mt-1 w-full resize-none rounded-xl border border-gray-200 px-3 py-2.5 text-sm leading-6" /></div>
