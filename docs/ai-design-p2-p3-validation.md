...
- `node --test --experimental-strip-types src/lib/magic-layers/*.test.ts src/app/api/paid-image-set-routes.test.ts` — 84 passed; includes every Magic Layers test, including composition candidates and the vision prompt/parser regression.
